...
// Other
const { checkPseudoFormat, checkPasswordFormat } = require('./../../../../../application/utils/middlewares')
...
describe('Unit | Api | Middlewares', () => {
  ...
  describe('#checkPasswordFormat', () => {
    ...
    beforeEach(() => {
      ...
      next = sinon.spy(checkPasswordFormat.next)
    })
    ...
    it('should send 403 status on invalid password format', () => {
      // given
      req.body = {
        password: 'password'
      }
      ...
      // when
      checkPasswordFormat(req, res, next)
    ...
    it('should call next() on valid password format', () => {
      // given
      req.body = {
        password: 'Tatayoyo1!'
      }
