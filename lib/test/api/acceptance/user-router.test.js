...
describe('Acceptance | Api | userRouter', () => {
  ...
  describe('#addUser', () => {
    ...
    it('should send a status 403 when a user try to signup with wrong format pseudo', (done) => {
      // given
      const data = {
        pseudo: 'yo',
        password: 'Tatatoto2020!',
    ...
    it('should send a status 403 when a user try to signup with wrong format password', (done) => {
      // given
      const data = {
        pseudo: 'Tatayoyo',
        password: 'lol',
